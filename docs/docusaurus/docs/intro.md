...
- **26 skills** across three layers:
  ...
  - **DeFi data (17)** — prices, TVL, yields, lending, Merchant Moe, Mantle Scan, wallet
- **15 CLI tools** — 6 engineering (`mantle-scaffold` … `mantle-report`) + 2 Tencent Cloud (`mantle-tencent-audit`, `mantle-cos-upload`) + 7 DeFi data (Mantlescan + Merchant Moe)
...
Show me the best yield on Mantle right now.
...
What's the total TVL on Mantle?
```
...
plugins/mantle-forge/skills/ # 24 skills total (7 engineering + 17 DeFi data)
